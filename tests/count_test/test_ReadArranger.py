...
class TestFQArrangerAdtAtac(TestCase):
    def setUp(self) -> None:
        ...
        read_record1 = FQRecordAdtAtac(read_block=read_block1, read_start=0, read_end=16)
        read_record2 = FQRecordAdtAtac(read_block=read_block2, read_start=3, read_end=21)
        self.fq_arranger_adt_atac = FQReadArrangerAdtAtac((read_record1, read_record2))
